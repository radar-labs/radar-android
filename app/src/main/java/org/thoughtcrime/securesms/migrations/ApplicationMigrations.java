...
//    static final int FIX_INACTIVE_GROUPS           = 127;
    ...
    static final int CONTACT_DISCOVERY_CONSENT     = 149;
  }
...
//    }
    ...
    if (lastSeenVersion < Version.CONTACT_DISCOVERY_CONSENT) {
      jobs.put(Version.CONTACT_DISCOVERY_CONSENT, new ContactDiscoveryConsentMigrationJob());
    }

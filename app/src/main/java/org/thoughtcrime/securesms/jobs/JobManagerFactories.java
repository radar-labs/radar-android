...
import org.thoughtcrime.securesms.migrations.ContactDiscoveryConsentMigrationJob;
...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put(ContactDiscoveryConsentMigrationJob.KEY,        new ContactDiscoveryConsentMigrationJob.Factory());
